...
def _exptext(exp="",
    ...
    loc2_dict = {
        0: {'xy': (0.001, 1.005 + pad),
            'va': 'bottom',
            },
        1: {'xy': (0.05, 0.9550 - pad),
            'va': 'bottom',
            },
        2: {'xy': (0.05, 0.9450 - pad),
            'va': 'top',
            },
        3: {'xy': (0.05, 0.95 - pad),
            'va': 'top',
    ...
    exp = ax.text(*loc1_dict[_exp_loc]['xy'], s=exp,
...
# Wrapper
def _explabel(ax=None, loc=0, data=False, paper=False, supplementary=False,
              year=2017, lumi=None, llabel=None, rlabel=None, fontname=None,
              fontsize=None, pad=0, exp="", italic=(False, False)):
