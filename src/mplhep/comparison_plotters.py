    ...
    **comparison_kwargs : optional
    ...
    if flow == "show":
        ...
        for tick in tick_positions:
            ...
            # Regular histogram spans from edges[0] to edges[-1]
            if tick < edges[0]:  # Underflow bin (before first regular edge)
                tick_labels.append(f"<{edges[0]:g}")
            elif tick > edges[-1]:  # Overflow bin (after last regular edge)
